...
OIDC login and role mapping were listed here as deferred past 1.0. They shipped in 1.4.0 — see
[the CLI reference](https://mockifyr.qorpe.com/cli/#admin-authentication). This section stays because
the next deliberate omission belongs here rather than in someone's inbox.
