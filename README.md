...
| `--decrypt-key <base64>` | 256-bit key enabling field-level payload decryption: a stub declaring `"decrypt": {"scheme":"jwe-dir-a256gcm","fields":[…]}` matches and templates against the decrypted values (the journal keeps the ciphertext) |
